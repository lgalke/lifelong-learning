...
OUTFILE="results/open_DOC_risk-reduction_alpha-values.csv"
...
for SEED in 10; do
	for DOC_THRESHOLD in "0.5" "0.25" "0.0"; do
		# for DOC_ALPHA in "0.5" "1.0" "1.5" "2"; do
		for DOC_ALPHA in "2.5" "3.0"; do
			OLG_ARGS="--open_learning doc --doc_threshold $DOC_THRESHOLD --doc_reduce_risk --doc_alpha $DOC_ALPHA"
			for i in ${!HPARAMS[@]}; do
				echo "${HPARAMS[$i]}"
